...
export class ManagedGkeCluster extends pulumi.ComponentResource {
    ...
    constructor(name: string,
        ...
        this.GkeKubeConfig = pulumi.all([gkeCluster.name, gkeCluster.endpoint, gkeCluster.masterAuth]).apply(([name, endpoint, auth]) => {
...
`;
        ...
        this.GkeProvider = new k8s.Provider(`${name}-provider`, {
